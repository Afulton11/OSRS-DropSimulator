...
public final class AliasMethod {
    ...
    public AliasMethod(List<Double> probabilities) {
        this(probabilities, new Random((long) (Math.random() * Long.MAX_VALUE)));
    }
...
//        final double average = 1.0 / probabilities.size();
        double unCalcAvg = 0.0;
        for(double probabilitiy : probabilities) {
            unCalcAvg += probabilitiy;
        }
        final double average = unCalcAvg / probabilities.size();
